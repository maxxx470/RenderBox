...
const en: Record<keyof typeof fr, string> = {
  ...
  'app.contextChipLabel': 'Context',
  'app.contextHint': 'What the engine already knows about this project, sent with every render.',
  'app.contextEmpty': 'Nothing yet. Materials are read off your first render, then reused.',
  'app.elementsEmpty': 'This project has no image to reuse yet.',
  ...
  'app.commandBarUpload': 'Add images',
  'app.commandBarUploading': 'Uploading…',
  ...
  'parametres.freeAccessBody': 'Free access — no account needed for now.',
