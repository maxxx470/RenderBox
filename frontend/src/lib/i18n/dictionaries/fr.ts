const fr = {
  ...
  'app.modeVideo': 'Vidéo',
  'app.modeSoonBadge': 'bientôt',
  'app.modeVideoSoon': 'La génération vidéo arrive dans une prochaine mise à jour.',
  ...
  'dashboard.showcaseEmptyTitle': 'Vitrine en préparation',
